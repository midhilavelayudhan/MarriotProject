...
import { SuitesArray } from './PhotoImages'
                                 ...
                                 <Card square className="photoImageCard">
                                   <CardMedia 
                                     className="photocardMedia"
                                      image={simages.img_src}
                                      title="Image title"
                                    /> 
                                </Card>
                              </CardActionArea>
                              <CardActions className="photoIconButton">
                                 <Button onClick={()=> handleOpen(simages.img_id)}>
                                   <img src={HambergMenuIcon}  width="45.1rem" alt=""/>
                                 </Button>
                                 <Typography className="photoIconTitle">{simages.img_name}</Typography>
                              </CardActions>
                            </Grid>)
                        })
                      }
                              ...
                              <Grid className={classes.ModalMain}>
                                <Grid>
                                  <Grid className={classes.ModalContentMain}>
                                    <h2 className={classes.ModalContentHeading}>{SuitesArray[imageId].modal_title}</h2>
                                    <p className={classes.ModalContentPara}>{SuitesArray[imageId].modal_content}</p>
                                  </Grid>
