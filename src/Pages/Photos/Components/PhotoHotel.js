...
import { HotelViewArray } from './PhotoImages';
        ...
        <div className="photoCardsRoot">
            ...
            <Container className="photoContainerGrid">
              <Grid container spacing={4}>
                   ...
                   { 
                     HotelViewArray.map((himages,key)=>{
                       return(
                        <Grid item  xs={12} sm={6} md={4}>
                          <CardActionArea>
                             <Card square className="photoImageCard" >
                                <CardMedia className="photocardMedia"
                                  image={himages.img_src}
                                  title="Image title"
                                /> 
                              </Card>
                           </CardActionArea>
                           <CardActions className="photoIconButton">
                               <Button onClick={()=> handleOpen(himages.img_id)}>
                                  <img src={HambergMenuIcon}  width="45.1rem" alt=""/>
                               </Button>
                              
                            
                            <Typography className="photoIconTitle">{himages.img_name}</Typography>
                            </CardActions>
                        </Grid>)
                   })
                }
                        ...
                        <Grid className={classes.ModalMain}>
                            <Grid>
                                <Grid className={classes.ModalContentMain}>
                                    <h2 className={classes.ModalContentHeading}>{HotelViewArray[imageId].modal_title}</h2>
                                    <p className={classes.ModalContentPara}>{HotelViewArray[imageId].modal_content}</p>
                                </Grid>
