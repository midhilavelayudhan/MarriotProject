...
import { DiningArray } from './PhotoImages'
                            ...
                            <CardActionArea>
                               <Card square className="photoImageCard">
                                  <CardMedia 
                                      ...
                                      image={dimage.img_src}
                                      title="Image title"
                                    /> 
                                </Card>
                            </CardActionArea>
                            <CardActions className="photoIconButton">
                                <Button onClick={()=> handleOpen(dimage.img_id)}>
                                    <img src={HambergMenuIcon}  width="45.1rem" alt=""/>
                                </Button>
                                <Typography className="photoIconTitle">{dimage.img_name}</Typography>
                            </CardActions>
                        </Grid>)
                     })
                }
                        ...
                        <Grid className={classes.ModalMain}>
                            <Grid>
                                <Grid className={classes.ModalContentMain}>
                                    <h2 className={classes.ModalContentHeading}>{DiningArray[imageId].modal_title}</h2>
                                    <p className={classes.ModalContentPara}>{DiningArray[imageId].modal_content}</p>
                                </Grid>
