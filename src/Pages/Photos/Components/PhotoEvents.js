...
import { EventsArray } from './PhotoImages'
                            ...
                            <CardActionArea>
                               <Card square className="photoImageCard">
                                  <CardMedia 
                                      ...
                                      image={eimage.img_src}
                                      title="Image title"
                                    /> 
                                </Card>
                            </CardActionArea>
                            <CardActions className="photoIconButton">
                                <Button onClick={()=> handleOpen(eimage.img_id)}>
                                    <img src={HambergMenuIcon}  width="45.1rem" alt=""/>
                                </Button>
                                <Typography className="photoIconTitle">{eimage.img_name}</Typography>
                            </CardActions>
                        </Grid>
                        ...
                        <Grid className={classes.ModalMain}>
                            <Grid>
                                <Grid className={classes.ModalContentMain}>
                                    <h2 className={classes.ModalContentHeading}>{EventsArray[imageId].modal_title}</h2>
                                    <p className={classes.ModalContentPara}>{EventsArray[imageId].modal_content}</p>
                                </Grid>
