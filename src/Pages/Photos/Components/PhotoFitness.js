...
import { FitnessArray } from './PhotoImages'
        ...
        <div className="photoCardsRoot">
            ...
            <Container className="photoContainerGrid">
               <Grid container spacing={4}>
                 ...
                 {
                     FitnessArray.map((fitimage,key)=>{
                         return(
                            <Grid item  xs={12} sm={6} md={4}>
                            <CardActionArea>
                               <Card square className="photoImageCar">
                                  <CardMedia 
                                      className="photocardMedia"
                                      image={fitimage.img_src}
                                      title="Image title"
                                    /> 
                                </Card>
                            </CardActionArea>
                            <CardActions className="photoIconButton">
                                <Button onClick={()=> handleOpen(fitimage.img_id)}>
                                    <img src={HambergMenuIcon}  width="45.1rem" alt=""/>
                                </Button>
                                <Typography className="photoIconTitle">{fitimage.img_name}</Typography>
                            </CardActions>
                        </Grid>
                         )
                     })
                        ...
                        <Grid className={classes.ModalMain}>
                            <Grid>
                                <Grid className={classes.ModalContentMain}>
                                    <h2 className={classes.ModalContentHeading}>{FitnessArray[imageId].modal_title}</h2>
                                    <p className={classes.ModalContentPara}>{FitnessArray[imageId].modal_content}</p>
                                </Grid>
